    ...
    >
      <div className="grid md:grid-cols-2 max-w-[1240px] m-auto">
        <div className="flex flex-col justify-center md:items-start w-full px-2 py-8">
          <p className="text-2xl">Unique Seq</p>
          <h1 className="py-3 text-5xl md:text-7xl font-bold">Cloud Mgt</h1>
          <p className="text-2xl">This is...</p>
          <button className="py-3 px-6 sm:w-[60%] my-4">Get started</button>
        </div>
        <div>
          <img className="w-full" src={bgImg} alt="cyber" />
        </div>
        <div
        ...
        >
          ...
          <div className="flex justify-between flex-wrap px-4">
            <p className="flex px-4 py-2 text-slate-500">
              <CloudUploadIcon className="h-6 text-indigo-600" /> App Secuity
            </p>
            <p className="flex px-4 py-2 text-slate-500">
